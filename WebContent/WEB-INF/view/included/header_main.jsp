...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <form class="form-inline ml-3">
        <div class="input-group input-group-sm">
            <input disabled class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <!-- 使い方 -->
        <!-- TODO:使い方ページ作成 -->
        <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-question-circle"></i>使い方</a></li>
        <!-- ログアウト -->
        <li class="nav-item"><a class="nav-link" href="home_doLogout"><i class="fas fa-sign-out-alt"></i>ログアウト</a></li>
    </ul>
</nav>
